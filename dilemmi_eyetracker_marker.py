...
"""
# --- Import packages for Neon Pupil Labs ---
import os
import time
import nest_asyncio
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/daniele/Desktop/file_daniele/eyetracking/psychopy_final/dilemmi_lastrun.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    while continueRoutine:
        ...
        if cross_tutorial.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            ...
            device.send_event("cross_tutorial", event_timestamp_unix_ns=time.time_ns())
        ...
        if dilemma_1_tutorial.status == NOT_STARTED and tThisFlip >= 3-frameTolerance:
            ...
            # send event to eyetracker
            device.send_event("dilemma_1_tutorial", event_timestamp_unix_ns=time.time_ns())
...
if __name__ == '__main__':
    ...
    device.send_event("recording_end", event_timestamp_unix_ns=time.time_ns())
